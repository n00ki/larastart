  ...
  >
    ...
    <section class="w-full max-w-3xl">
      <h2 class="text-sm font-light">
        ...
        >
          Rails doctrine
        </a>, <em>LaraStart</em> offers an opinionated selection of tools and a structured
        approach for your next web application. It provides a robust foundation with
        carefully chosen defaults, while preserving the flexibility to customize and
        extend as your project needs evolve.
      </h2>
    </section>
  </div>
</div>
