...
<BaseLayout>
  <div class="flex min-h-screen flex-col items-center gap-8 px-4 py-8">
    <header class="flex w-full max-w-3xl items-center justify-between">
      <div>
        <Button href="https://github.com/n00ki/larastart" target="_blank" rel="noopener noreferrer" variant="outline" class="
          transition-none
        ">
    ...
    <div class="flex w-full max-w-3xl flex-1 flex-col items-center justify-center gap-8">
      <section class="text-center">
        <img src="https://res.cloudinary.com/nshemesh/image/upload/v1756715372/larastart/logo.png" alt="logo" class="
          mx-auto size-16
          md:size-24
        " />
