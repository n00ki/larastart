...
- Enforced explicit `Model::query()` calls through Larastan
- Excluded agent configuration and vendor directories from Vite's file watcher
- Updated dependencies

### Fixed

- Cancelled pending Inertia form submissions when their components unmount
- Initialized two-factor authentication attributes on new user instances
